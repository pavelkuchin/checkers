    ...
    INSERT INTO Game(gauid, board, created, description, lastStep, modified, name, state, type, black_uuid, white_uuid) VALUES (null, '10x10', NOW(), 'Ogogo', NOW(), NOW(), 'Just a game', 'open', 'long', 2, 1);
